# Генератор задач
**Генератор задач** представляет собой desktop-приложение, позволяющее генерировать большое количество шаблонизированных задач с решениями. Для запуска генерации необходимо указать путь к *файлу конфигурации*, желаемое количество задач 
# Файл конфигурации
